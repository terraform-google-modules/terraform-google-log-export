...
control "gcloud" do
  title "Log exports - folder level storage destination - gcloud commands"

  describe command("gcloud logging sinks list --folder #{log_export_map['sink_parent_id']} --filter=\"name:#{log_export_map['sink_resource_names']}\" --format json") do
