...
| expiration\_days | Table expiration period in days. If both table\_expiration\_days and partition\_expiration\_days are not set, logs will never be deleted. | `number` | `null` | no |
