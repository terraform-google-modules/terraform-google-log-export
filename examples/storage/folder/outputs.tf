...
output "log_export_map" {
  ...
  value = {
    ...
    sink_resource_ids   = "${module.log_export.sink_resource_ids}"
    sink_resource_names = "${module.log_export.sink_resource_names}"
    sink_parent_id      = "${module.log_export.sink_parent_id}"
...
output "destination_map" {
  ...
  value = {
    ...
    self_links       = "${module.log_export.destination_self_links}"
