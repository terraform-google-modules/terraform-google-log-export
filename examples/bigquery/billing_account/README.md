# Log Export: BigQuery destination at Billing Account level

This example configures a billing-account-level log sink that feeds a bigquery dataset destination
